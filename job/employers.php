    ...
    <!-- <section class="category-area category-area-two pt-100 pb-70">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-two wow fadeInUp"
              data-wow-delay=".4s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-three wow fadeInUp"
              data-wow-delay=".5s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-four wow fadeInUp"
              data-wow-delay=".6s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-five wow fadeInUp"
              data-wow-delay=".7s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-six wow fadeInUp"
              data-wow-delay=".3s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-seven wow fadeInUp"
              data-wow-delay=".4s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-eight wow fadeInUp"
              data-wow-delay=".5s"
            >
          ...
          <div class="col-sm-4 col-lg-3">
            <div
              class="category-item category-nine wow fadeInUp"
              data-wow-delay=".6s"
            >
          ...
          <div class="col-sm-4 offset-sm-4 offset-lg-0 col-lg-3">
            <div
              class="category-item category-ten wow fadeInUp"
              data-wow-delay=".7s"
            >
