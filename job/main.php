        ...
        <div class="row">
            ...
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">UI/UX Designer</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Winbrans.com</a>
                  <ul>
                    <li>
                ...
                <div class="job-inner-right">
                  <ul>
                    <li>
                      <a href="job/create-account.html">Apply</a>
                    </li>
                    <li>
                      <span>Full Time</span>
                    </li>
          ...
          <div class="col-lg-6 mix ui web">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3><a href="job/job-details.html">Android Developer</a></h3>
                  <a class="company" href="job/company-details.html">Infiniza.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix branding wp">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">Senior Manager</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Glovibo.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix ux branding">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">Product Designer</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Bizotic.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix wp web">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">Digital Marketer</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Hotelzo.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix web ui">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">Sales Manager</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Gozuto.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix ux ui">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">Web Developer</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Udiza.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
          ...
          <div class="col-lg-6 mix branding web">
            <div class="job-item">
              ...
              <div class="job-inner align-items-center">
                <div class="job-inner-left">
                  <h3>
                    <a href="job/job-details.html">SEO</a>
                  </h3>
                  <a class="company" href="job/company-details.html">Oqota.com</a>
                  <ul>
                    <li>
                      <i class="icofont-money-bag"></i>
                      $20k - $25k
